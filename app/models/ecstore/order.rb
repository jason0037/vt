  ...
  attr_accessor :ship_day,:ship_special,:ship_time2
      ...
      has_many :reships, :foreign_key=>"order_id"
       ...
       def calculate_order_amount
          ...
          # ====commission amount===
          self.commission = self.order_items.select{ |order_item| order_item.item_type == 'product' }.collect{ |order_item|  order_item.amount *order_item.good.share}.inject(:+).to_f
       end
