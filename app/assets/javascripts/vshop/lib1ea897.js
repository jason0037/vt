...
}), b.param = function(e, n, r) {
var i, s = [], o = function(e, t) {
t = b.isFunction(t) ? t() : t == null ? "" : t, s[s.length] = encodeURIComponent(e) + "=" + encodeURIComponent(t);
};
n === t && (n = b.ajaxSettings && b.ajaxSettings.traditional);
if (b.isArray(e) || e.jquery && !b.isPlainObject(e)) b.each(e, function() {
o(this.name, this.value);
}); else for (i in e) vn(i, e[i], n, o);
return s.join("&").replace(ln, " ");
...
n.exports = template;
}) : typeof exports != "undefined" && (module.exports = template);;/*members "", "\b", "\t", "\n", "\f", "\r", "\"", JSON, "\\", apply,
...
if (typeof JSON.stringify != "function" || typeof JSON.stringify == "function" && JSON.stringify("中").length > 3) JSON.stringify = function(e, t, n) {
var r;
gap = "", indent = "";
...
for (var n in e) if (e.hasOwnProperty(n) && t.call(e, e[n], n) === !1) break;
}
...
}), e.fn.placeholder = t, e("textarea[maxlength]").bind("input propertychange", function() {
