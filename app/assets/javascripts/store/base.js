...
$(document).ready(function(){
  ...
  $('#items .jcarousel-skin-tango, #btm_items .jcarousel-skin-tango, #more_products .jcarousel-skin-tango').jcarousel({
    // wrap: 'both',
    scroll: 5
...
function getPrice(obj,url,params){
    ...
    $.get(url,params,function(res){
        $(obj).closest("form").find(".name_and_price .price .georgia").html("￥" + res + "&nbsp;&nbsp;&nbsp;\n");
    });
}